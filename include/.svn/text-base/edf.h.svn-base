 ...
 *		   the file could not be opened or the file is curropt.
 ...
 *		   operation suceeded otherwise a non zero is returned.
 ***********************************************************************/
 ...
 *Input:		 edffile
 *Output: int
 *Purpose: retuns the float data with the type returned by
 *			edf_get_next_data
 ***********************************************************************/
 ...
 *Input:		 edffile
 *Output: int
 *Purpose: retuns the float sample close to the time time
 ***********************************************************************/
 ...
 *Output: int
 *Purpose: sets the string that marks the begining of the trial
 ***********************************************************************/
 ...
 *Input:		 edffile
 *Output: int
 *Purpose: gets the string that marks the begining of the trial
 ***********************************************************************/
 ...
 *Input:		 edffile
 *Output: int
 *Purpose: jumps to the begining of a given trial.
 ***********************************************************************/
...
ELCL 
*/
void EXPORT edf_get_uncorrected_raw_pupil(FSAMPLE *sam, float *rv);
void EXPORT edf_get_uncorrected_raw_cr(FSAMPLE *sam, float *rv);
UINT32   EXPORT edf_get_uncorrected_pupil_area(FSAMPLE *sam);
UINT32   EXPORT edf_get_uncorrected_cr_area(FSAMPLE *sam);
void EXPORT edf_get_pupil_dimension(FSAMPLE *sam, UINT32 *rv);
void EXPORT edf_get_cr_dimension(FSAMPLE *sam, UINT32 *rv);
void EXPORT edf_get_window_position(FSAMPLE *sam, UINT32 *rv);
void EXPORT edf_get_pupil_cr(FSAMPLE *sam, float *rv);
