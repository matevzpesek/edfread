@echo off
rem C:\Dokumente und Einstellungen\Administrator\Application Data\MathWorks\MATLAB\R14\mexopts.bat
rem Generated by gnumex.m script in f:\gnumex-1.11\gnumex-1.11
...
rem
set MATLAB=F:\PROGRA~1\MATLAB7
set GM_PERLPATH=F:\PROGRA~1\MATLAB7\sys\perl\win32\bin\perl.exe
set GM_UTIL_PATH=f:\gnumex-1.11\gnumex-1.11
set PATH=F:\MinGW\bin;%PATH%
rem
rem precompiled library directory
set GM_QLIB_NAME=f:\gnumex-1.11\gnumex-1.11
rem
...
set OPTIMFLAGS=-O3 -malign-double -fno-exceptions -ffast-math -march=pentium4 -mfpmath=sse
rem set OPTIMFLAGS=-O2
set DEBUGFLAGS=-g
